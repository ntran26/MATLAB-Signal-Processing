...
load data\lab2-1\case_1.lvm;
load data\lab2-1\case_2.lvm;
load data\lab2-1\case_3.lvm;
load data\lab2-1\case_4.lvm;
load data\lab2-1\case_5.lvm;
load data\lab2-1\case_6.lvm;
load data\lab2-1\case_7.lvm;
load data\lab2-1\case_8.lvm;

A = case_7;

% For DFT
L = 200;                % length of data
Fs = 280;               % sampling frequency
T = 1/Fs;               % period
...
%text(DL_6351_peak - 5, peak_value - 0.25*peak_value, ['Frequency = ', num2str(DL_6351_peak), ' Hz'], 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'left', 'FontSize', 10, 'Color', 'blue');
...
%text(Tenma_6351_peak - 5, peak_value - 0.25*peak_value, ['Frequency = ', num2str(Tenma_6351_peak), ' Hz'], 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'left', 'FontSize', 10, 'Color', 'blue');
...
%text(DL_6000_peak - 5, peak_value - 0.25*peak_value, ['Frequency = ', num2str(DL_6000_peak), ' Hz'], 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'left', 'FontSize', 10, 'Color', 'blue');
...
%text(Tenma_6000_peak - 5, peak_value - 0.25*peak_value, ['Frequency = ', num2str(Tenma_6000_peak), ' Hz'], 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'left', 'FontSize', 10, 'Color', 'blue');
